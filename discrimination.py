...
def discrimination(cand_img, im_cand_dir):
    """
    Input:
    ...
    print("3.3 reshape positive pixel coordinates into form for PCA function")
    ...
    print("3.4 complete PCA, derive angle deviation and apply")
    ...
    # save fig
    plt.imsave(im_cand_dir + "3.4 rotated candidate image.png", cand_img_rot)


    # get newly rotated positive pixel locations
    print("3.5 get newly rotated positive pixel locations")
    ...
    print("3.6 generate positive pixel dataframe")
    ...
    print("3.7 get fringe coordinates and generate feature values from it")
    ...
    return length, breadth, area, lb_ratio
